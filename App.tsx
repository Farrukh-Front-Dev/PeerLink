...
function App() {
  ...
  return (
    <>
      {/* FIXED BACKGROUND - Covers entire viewport, prevents white gaps */}
      <div 
        className="fixed inset-0 z-[-1] min-h-screen"
        style={{
      ...
      <div className="flex flex-col min-h-screen overflow-hidden" style={{ height: '100vh', maxHeight: '100vh' }}>
        
        {/* HEADER */}
        <header className="sticky top-0 z-40 bg-black/30 backdrop-blur-xl border-b border-white/10 shadow-2xl pt-[env(safe-area-inset-top)] flex-shrink-0">
        ...
        <main className="flex-1 max-w-[1600px] w-full mx-auto px-4 py-8 overflow-y-auto overflow-x-hidden custom-scrollbar">
